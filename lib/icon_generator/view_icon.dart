      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Large preview (200x200 display size)
            Container(
            ...
            ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('In a real app, this would generate icon files for different platforms'),
                    duration: Duration(seconds: 3),
                  ),
                );
              },
              child: const Text('Generate Icon Files'),
            ),
            ...
            const Padding(
              ...
              child: Text(
                'This icon shows a tic-tac-toe board with X\'s (white) and O\'s (orange/red) in a classic game position. '
                'The blue background matches your app\'s primary color theme.',
